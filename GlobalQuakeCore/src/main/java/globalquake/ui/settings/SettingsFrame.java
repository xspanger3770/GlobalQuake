...
public class SettingsFrame extends GQFrame {
    ...
    public SettingsFrame(Component parent, boolean isClient) {
        ...
        // Check if an instance is already open, if so, bring it to the front and return
        if (openInstance != null && openInstance.isVisible()) {
            openInstance.bringToFront();
            return;
        }
        openInstance = this;
        initialize(parent);
    ...
    // Add this method to get the instance of SettingsFrame
