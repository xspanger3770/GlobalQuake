...
public class MMIIntensityScale implements IntensityScale{
	...
	static {
		...
		levels.add(II = new Level("II", 1.0, new Color(200, 190, 240)));
		levels.add(III = new Level("III", 2.1, new Color(132, 162, 232)));
		levels.add(IV = new Level("IV", 5.0, new Color(130, 214, 255)));
		...
		levels.add(XII = new Level("XII", 1972.0, new Color(65, 0, 0)));
